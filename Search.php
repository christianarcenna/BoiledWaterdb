...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p> Search Games from the Database below, Please Type the name Exactly the same: </p>

     
    <!-- Text Area to obtain input and Search -->
    <textarea id="Search_Input" name="Searchbox"></textarea>
    <input type="button" value="Search" onclick="getText()" />
        
        
    <script>
        //Obtain value from Textbox 
        function getText() {
        var text = document.getElementById("Search_Input").value;
        
        //Search by URL by relocating to search2.php with an extension on the URL
        window.location.href = "search2.php?name=" + text;
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th> App ID </th> <th> App Name </th> <th> Release Date </th> <th> Genre </th> <th> Sales </th> <th> Developer ID </th>
