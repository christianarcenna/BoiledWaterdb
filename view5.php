...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="games.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <p>Show games with the genre Action</p>
    ...
    $result = pg_query($conn, "SELECT app_id, app_name, genre, price, score
                                FROM games
                                WHERE genre = 'Action'
                                ");
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App ID</th> <th>App Name</th><th>Genre</th><th>Price</th><th>Metacritic</th> </tr>";
    $i = 0;
