...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Show all dlc for each game grouped by game (Common View 2) </p>
    ...
    $result = pg_query($conn, "SELECT app_id, app_name
            FROM games
            WHERE app_id IN (SELECT app_id FROM dlc WHERE dlc_id IS NOT NULL)
            ORDER BY app_id ASC
                            ");
    if (!$result) {
        echo "An error occurred.\n";
