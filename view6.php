...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Show a list of games/dlc from certain publishers and developers (Common View 1)
</p>
    ...
    $result = pg_query($conn, "SELECT app_name, dlc_name 
                                FROM (((games JOIN dlc on games.app_id = dlc.app_id) JOIN developer on games.developer = developer.d_id) JOIN publisher on publisher.publisher_id = games.publisher)
                                WHERE d_name='Valve' AND publisher_name='Valve' ");
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App ID</th> <th>App Name</th> </tr>";
    $i = 0;
