...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <center><img src=logo2.png width="50%" height="50%"></center><br>
            ...
            <p>Find all games that have history data available (Common View 3)</p>
    ...
    $result = pg_query($conn, "SELECT * FROM games
                                WHERE app_id IN (SELECT app_id FROM history)
                            ");
    if (!$result) {
        echo "An error occurred.\n";
        exit;
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App ID</th> <th>App Name</th><th>Date</th><th>Genre</th><th>idk</th><th>Developer</th><th>Publisher<th>price</th><th>Metacritic</th></tr>";
    $i = 0;
