...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p> Showing the lowest price of the Game Portal with app_id 400</p>
    ...
    $result = pg_query($conn, "SELECT MIN(Price)
                               FROM history
                               WHERE app_id=400
                            ");
    if (!$result) {
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th> Lowest Price </th></tr>";
    $i = 0;
