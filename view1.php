...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Showing the price history of a certain game</p>
    ...
    $result = pg_query($conn, "SELECT history.app_id, app_name, history.price, yearmonth
                            FROM games RIGHT JOIN history on games.app_id = history.app_id
                            WHERE history.app_id = 10
                            ORDER BY yearmonth
                            ");
    if (!$result) {
        echo "An error occurred.\n";
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App ID</th> <th>App Name</th><th>Price</th><th>Date</th> </tr>";
    $i = 0;
