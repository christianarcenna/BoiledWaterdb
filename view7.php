...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Show list of games and their DLC if there is any available (Common View 4)
</p>
    ...
    $result = pg_query($conn, "SELECT games.app_name, dlc.dlc_name, dlc.price
FROM Games FULL JOIN dlc ON Games.app_id = dlc.app_id
WHERE dlc_name IS NOT NULL
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App Name</th> <th>DLC Name</th><th>Price</th></tr>";
    $i = 0;
