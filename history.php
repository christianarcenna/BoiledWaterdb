...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p> Values of the History Table in our Database</p>
    ...
    $result = pg_query($conn, "SELECT * FROM history");
    if (!$result) {
        echo "An error occurred.\n";
        exit;
    }
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th> History ID </th> <th> App ID </th> <th> Price </th> <th> Date </th></tr>";
    $i = 0;
