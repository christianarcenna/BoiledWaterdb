...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p> Values of the Developer Table in our Database</p>
    ...
    $result = pg_query($conn, "SELECT * FROM developer");
    if (!$result) {
        echo "An error occurred.\n";
        exit;
    }
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th> Developer ID </th> <th> Developer Name </th> </tr>";
    $i = 0;
