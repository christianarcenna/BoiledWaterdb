...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Showing games within a certain price range in descending order</p>
    ...
    $result = pg_query($conn, "SELECT app_id, app_name, price, genre, score
                                FROM games
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App ID</th> <th>App Name</th><th>Price</th><th>Genre</th><th>Metacritic</th> </tr>";
    $i = 0;
