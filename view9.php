...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Compare price history of 2 games (Common View 5)</p>
    ...
    $result = pg_query($conn, "SELECT games.app_name, history.price, history.yearmonth
                                FROM games, history
                                WHERE games.app_id = 20
                                UNION
                                SELECT games.app_name, history.price, yearmonth
                                FROM games, history
                                WHERE games.app_id = 30
                                ORDER BY yearmonth
                            ");
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th>App Name</th> <th>Price</th><th>Date</th></tr>";
    $i = 0;
