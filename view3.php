...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <p>Showing the DLC details of a certain game</p>
    ...
    $result = pg_query($conn, "SELECT * FROM DLC
                                WHERE app_id = 400"
                                );
    if (!$result) {
        echo "An error occurred.\n";
    ...
    echo "<div class='table-responsive'><table id='database' class='table table-striped'> <tr> <th> DLC ID </th> <th> DLC Name </th> <th> Price </th> <th> Release Date </th> <th> Sales </th> <th> App ID </th> </tr>";
    $i = 0;
    $i = 0;
